...
| Notifications | `Controller.cpp:685-690, 796-804, 807-814` | `KNotification` + `data/app.lane.Lane.notifyrc` | Qt tray message or macOS User Notifications | Qt tray message or Win10 toast | **None** |
